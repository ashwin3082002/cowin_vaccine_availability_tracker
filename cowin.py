...
pin = ["600035"] #Enter Your Pincode. You can also enter multiple pincode by seperating them with a ,
num_day = 1      #Enter the number of days from today that you want to check the availability
all_dates = []
                ...
                for center in json_result["centers"]:
                    for session in center["sessions"]:
                        if (session['available_capacity']>0):
                            ...
                            print("No of Vaciness Avaliable: ", session["available_capacity"])
